package com.example.lenovo.xsnsappv2.ui;
...
public class ShowAllImageProjectRvItemRecoration extends RecyclerView.ItemDecoration {

    private int divider;

    public ShowAllImageProjectRvItemRecoration(Context context) {
